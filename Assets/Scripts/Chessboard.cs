...
public class Chessboard : MonoBehaviour
{
    ...
    // LOGIC
    //Size of our board TILES_X x TILES_Y
    ...
    private void Awake()
    {
        GenerateGrid(1, TILE_COUNT_X, TILE_COUNT_Y);
    }
    private void Update()
    {
        if (!currentCamera)
        ...
        if (Physics.Raycast(ray, out info, 200, LayerMask.GetMask("Tile", "Hover")))
        {
    ...
    private Vector2Int LookupTileIndex(GameObject hitInfo)
    {
        ...
        return -Vector2Int.one; //Invalid - causes crash if we reach -1 tile
    }
}
